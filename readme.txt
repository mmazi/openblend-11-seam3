 ...
 This will deploy two artifacts, target/demo.war and
 default-ds.xml.
 ...
 Now you can either deploy the target/demo.war through the
 web-based GlassFish admininstration console, or you can again use asadmin:

  ./asadmin deploy target/demo.war

 To undeploy the application, run:

  ./asadmin undeploy demo
